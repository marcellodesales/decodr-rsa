...
/**
 * Implements the algebra formulas.
 * 
...
public enum Algebra {
  ...
  /**
   * @param a is the base of the module.
   * @param e is the exponent part of the module.
   * @param n is the number to be divided by.
  ...
  public long getRandomPrime(int range) {
    ...
    do {
      number =
          this.getARandomInteger(this.getARandomInteger(range))
